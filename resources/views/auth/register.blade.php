    ...
    <body>
            ...
            <div class="flex w-[1280px] px-[75px] py-5 items-center justify-between mx-auto">
                ...
                <div class="flex items-center gap-5 justify-end">
                    ...
                    <div class="flex items-center gap-3">
                        <a href="{{ route('login') }}" class="rounded-full border border-obito-grey py-3 px-5 gap-[10px] bg-white hover:border-obito-green transition-all duration-300">
                            <span class="font-semibold">Sign Up</span>
                        </a>
                        <a href="{{ route('register') }}" class="rounded-full py-3 px-5 gap-[10px] bg-obito-green hover:drop-shadow-effect transition-all duration-300">
        ...
        <main class="relative flex flex-1 h-full">
            <section class="flex flex-1 items-center py-5 px-5 pl-[calc(((100%-1280px)/2)+75px)]">
                <form method="POST" enctype="multipart/form-data" action="{{ route('register.store') }}" class="flex flex-col h-fit w-[510px] shrink-0 rounded-[20px] border border-obito-grey p-5 gap-4 bg-white">
                    @csrf
                    ...
                    <label class="relative flex items-center gap-3">
                        <button id="upload-photo" type="button" class="relative w-[90px] h-[90px] flex rounded-full overflow-hidden border border-obito-grey focus:ring-obito-green transition-all duration-300">
                            ...
                            <img id="photo-preview" src="{{ asset('assets/images/avatars/avatar-1.png') }}" class="w-full h-full object-cover hidden" alt="photo">
                        </button>
                    ...
                    <x-input-error :messages="$errors->get('photo')" class="text-red-600 mt-2 mb-2" />
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <x-input-error :messages="$errors->get('name')" class="text-red-600 mt-2" />
                    </div>
                    <div class="flex flex-col gap-2">
                        <p>Occupation</p>
                        <label class="relative group">
                        ...
                        <x-input-error :messages="$errors->get('occupation')" class="text-red-600 mt-2" />
                    </div>
                    <div class="flex flex-col gap-2">
                        <p>Email Address</p>
                        <label class="relative group">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <x-input-error :messages="$errors->get('password_confirmation')" class="text-red-600 mt-2" />
                    </div>
