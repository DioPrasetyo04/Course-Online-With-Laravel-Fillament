...
@section('title', 'Learning Finished -' . ' ' . $course->name . ' ' . '- Obito LMS')
@section('content')
    <x-navigation-auth />
        ...
        <main
            ...
            <div id="card"
                ...
                <div class="flex justify-center items-center overflow-hidden shrink-0 w-[180px] h-[130px] rounded-[14px]">
                    <img src="{{ asset('assets/images/thumbnails/thumbnail-9.png ') }}" alt="image" class="w-full h-full object-cover" />
                </div>
                <div class="flex flex-col gap-[10px]">
                    ...
                    <div class="flex items-center gap-[6px]">
                        ...
                        <p class="text-sm leading-[21px] text-obito-text-secondary">{{ $course->getCourseContentAttribute() }} Contents</p>
                    </div>
                </div>
            </div>
