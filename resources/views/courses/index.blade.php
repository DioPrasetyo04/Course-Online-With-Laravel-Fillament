...
@section('title', 'Catalog Courses - Obito LMS')
@section('content')
    <x-navigation-auth />
            ...
            <div class="grid grid-cols-2 gap-5">
                <a href="#" class="card">
                    <div
                        ...
                        <div class="flex flex-col gap-3">
                            <h3 class="font-bold text-lg line-clamp-2">Full-Stack Sr. Website JavaScript Developer 2025
                            </h3>
                ...
                <a href="#" class="card">
                    <div
                        ...
                        <div class="flex flex-col gap-3">
                            <h3 class="font-bold text-lg line-clamp-2">Digital Marketing Enterprise User Acquisitions
                                Level</h3>
                            <p class="flex items-center gap-[6px]">
                                <img src="{{ asset('assets/images/icons/briefcase-green.svg') }}" class="flex shrink-0 w-5" alt="icon">
                                <span class="text-sm text-obito-text-secondary">Rp 125.500.000/year</span>
                ...
                <div id="programming" class="tab-content grid grid-cols-4 gap-5">
                    ...
                    <a href="course-details.html" class="card">
                        <div
                            ...
                            <div class="flex flex-col p-4 pt-0 gap-[13px]">
                                <h3 class="font-bold text-lg line-clamp-2">Copywriting for New Z Generation Digitals
                                </h3>
                                <p class="flex items-center gap-[6px]">
                                    <img src="{{ asset('assets/images/icons/crown-green.svg') }}" class="flex shrink-0 w-5" alt="icon">
                                    <span class="text-sm text-obito-text-secondary">Programming</span>
                    ...
                    <a href="course-details.html" class="card">
                        <div
                            ...
                            <div class="flex flex-col p-4 pt-0 gap-[13px]">
                                <h3 class="font-bold text-lg line-clamp-2">Start Digital Business for 2025 Ecosystem AI
                                </h3>
                                <p class="flex items-center gap-[6px]">
                                    <img src="{{ asset('assets/images/icons/crown-green.svg') }}" class="flex shrink-0 w-5" alt="icon">
                                    <span class="text-sm text-obito-text-secondary">Programming</span>
                    ...
                    <a href="course-details.html" class="card">
                        <div
                            ...
                            <div class="flex flex-col p-4 pt-0 gap-[13px]">
                                <h3 class="font-bold text-lg line-clamp-2">UI UX Masterclass Figma Principles Design
                                </h3>
                                <p class="flex items-center gap-[6px]">
                                    <img src="{{ asset('assets/images/icons/crown-green.svg') }}" class="flex shrink-0 w-5" alt="icon">
                                    <span class="text-sm text-obito-text-secondary">Programming</span>
