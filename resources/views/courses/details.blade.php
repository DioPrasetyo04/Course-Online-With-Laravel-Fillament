...
@section('title', 'Courses Details -' . ' ' . $course->name . ' ' . '- Obito LMS')
@section('content')
    <x-navigation-auth />
                    ...
                    <div class="flex gap-4 items-center">
                        ...
                        <p class="flex items-center gap-[6px]">
                            <img src="{{ asset('assets/images/icons/menu-board-green.svg ') }}" class="w-6 flex shrink-0"
                                alt="icon">
                            <span class="font-semibold text-sm leading-[21px]">{{ $course->getCourseContentAttribute() }}
                                Content</span>
                        </p>
                    </div>
                    <div class="flex gap-4 items-center">
            ...
            <div id="contents" class="flex flex-col gap-5">
                ...
                <div id="tabs-content-container">
                    <div id="about-content" class="tab-content flex flex-col gap-[30px]">
                        <div id="description" class="flex flex-col gap-4 leading-7 w-full max-w-[844px] text-justify">
                            <p>{{ $course->about }}</p>
                        </div>
                            ...
                            <div class="grid grid-cols-2 gap-5">
                                @foreach ($course->courseMentors as $mentor)
                                    <div
                                        ...
                                        <p class="leading-7 text-justify">{{ $mentor->about }}</p>
                                    </div>
                                @endforeach
                            </div>
                        </div>
                        ...
                        @foreach ($course->courseSections as $section)
                            <div
                                ...
                                <div id="{{ $section->id }}" class="">
                                    <div class="flex flex-col gap-4">
                                        @foreach ($section->sectionContents as $sectionContent)
                                            <div
